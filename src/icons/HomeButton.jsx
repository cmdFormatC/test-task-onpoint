...
export default function HomeButton({ width = '48px', height = '42px', fill = 'none', className = '' }) {
    return (
        <svg 
            className={className}
            width={width}
        ...
        >
            <path fillRrule="evenodd"  stroke="rgb(40, 40, 40)" strokeWidth="2px" strokeLinecap="butt" strokeLinejoin="miter" fill="rgb(40, 40, 40)"
